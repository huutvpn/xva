...
bot = TelegramClient("adminbot","6","6406070059:AAFIpAWnbnnuikvxeWgz4rJwA5SrCVYe5VA").start(bot_token=BOT_TOKEN)
try:
	...
	c.execute("INSERT INTO admin (user_id) VALUES (?)",(6061644931,))
	x.commit()
